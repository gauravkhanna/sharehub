...
echo("<table width=\"1000\"><th>Filename</th><th>Extension</th><th>Protection Mode</th><th>Created on</th><th>Last updated</th><th>Download</th><th>Check log</th>");
while($tuple=mysql_fetch_object($result)) {
//echo var_dump($tuple);
echo("<tr>");
echo("<td>$tuple->filename</td>");
echo("<td>$tuple->filetype</td>");
if($tuple->storagetype==0)
	{
	echo("<td><img src=\"siteImages/lock.png\"></td>");
	}
else
	{
	echo("<td><img src=\"siteImages/unlock.png\"></td>");
	}
